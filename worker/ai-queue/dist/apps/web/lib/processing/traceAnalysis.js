 ...
 * 计算内容hash（用于缓存）
 */
function calculateContentHash(trace) {
 ...
 * @returns 分析结果
 */
export async function analyzeTrace(traceId) {
    // 获取溯源
    ...
    if (cachedAnalysis) {
        ...
        return {
            ...
            missingAspects: cachedAnalysis.missingAspects,
...
- 改进建议应具体、可操作`;
        ...
        await saveAnalysisWithHash(traceId, {
            ...
            sourceEvaluation: analysisResult.sourceEvaluation,
