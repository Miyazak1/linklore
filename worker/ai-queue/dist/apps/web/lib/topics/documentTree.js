 ...
 */
export async function getDocumentTree(topicId, includeText = false) {
 ...
 * - 检查深度限制
 */
export async function validateParentId(parentId, topicId, currentDocId) {
    if (!parentId) {
 ...
 * 计算文档深度（从根节点到该文档的层数）
 */
export async function getDocumentDepth(documentId) {
    let depth = 0;
